# Borrow from:
# https://github.com/MinnPost/MinnBot/blob/master/scripts/statuscats.coffee
#
# Description:
#   Displays statuscat images
#
# Dependencies:
#   None
#
...
#   hubot <http-code> me - displays specific http status code cat
#
# Author:
#   Tom Nehil
